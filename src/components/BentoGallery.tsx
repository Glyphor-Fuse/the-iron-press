  ...
  return (
    <section className="py-32 px-6 lg:px-24 bg-obsidian">
      <div className="grid grid-cols-12 grid-rows-6 gap-6 h-[120vh]">
        ...
        >
          <img src="https://images.pexels.com/photos/5505931/pexels-photo-5505931.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" alt="NYC Space" />
        ...
        >
          <img src="https://images.pexels.com/photos/34563915/pexels-photo-34563915.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" alt="Service" />
        </motion.div>
        ...
        >
          <img src="https://images.pexels.com/photos/30193123/pexels-photo-30193123.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" alt="Street" />
        </motion.div>
